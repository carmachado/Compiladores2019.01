...
public class Sintatico implements Constants
{
    ...
    private String trataMensagem(String prMensagem, String encontrado) {
       return "encontrado " + encontrado + " " + prMensagem.toLowerCase(); 
    }
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError
    {
        if (currentToken == null)
        {
            ...
            currentToken = new Token(DOLLAR, "$", pos, previousToken.getLinha());
        }
        ...
        else if (isTerminal(x))
        {
            ...
            {
                throw new SyntaticError(trataMensagem(PARSER_ERROR[x], currentToken.getLexeme()), currentToken.getPosition(), currentToken.getLinha());
            }
        }
